...
(function () {
  ...
  function tripDetail(t) {
    ...
    return `<div class="trip-detail">
      ...
      ${t.photo ? `<img src="/api/photo?ref=${encodeURIComponent(t.photo)}" alt="photo des prises" loading="lazy" style="margin-top:12px;max-width:220px;border-radius:4px;border:1px solid var(--line)">` : ""}
      ${isAdmin()
        ? `<div style="margin-top:12px"><button class="btn ghost small" data-del="${t.id}">Supprimer</button></div>`
